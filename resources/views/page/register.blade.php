...
<section  id="cover-page">    
        <div class="row">
            <div class="col-lg-5 col-12 hidden-xs desc"  data-aos="fade-up" data-aos-duration="1500">
                <h1 class="nunito">Pendaftaran<br><span class="main-text">IV LAB<span></h1>
                <p class="text-white nunito">
                Innovation Village Lab  adalah platform untuk memudahkan BUMDES menemukan objek usaha yang sesuai dengan potensi desa.
                </p>
                <a href="{{url('/login')}}" class="btn bt-linear nunito">Masuk Akun</a>
            </div>
            <div class="col-lg-6 col-12">
                <div class="login-box">
                    <div class="label-box">Pendaftaran</div>
                    <br>
                    <form action="{{url('/reg')}}" method="post">
                    {{csrf_field()}}    
                    <div class="form-group">
                        <label class="nunito">Nama Bumdes</label>
                        <input required="required" type="text" name="nama_bumdes" class="form-control">
                    </div>
                    <div class="form-group">
                        <label class="nunito">Desa</label>
                        <input required="required" type="text" name="desa" class="form-control">
                    </div>
                    <div class="form-group">
