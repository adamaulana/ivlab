...
<section  id="cover-page">    
        <div class="row">
            <div class="col-lg-6 col-12 hidden-xs desc"  data-aos="fade-up" data-aos-duration="1500">
                ...
                Vilagel Innovation Lab  adalah platform untuk memudahkan BUMDES menemukan objek usaha yang sesuai dengan potensi desa.
                </p>
                <a href="{{url('/pendaftaran')}}" class="btn bt-linear nunito">Daftar Sekarang</a>
            </div>
            <div class="col-lg-4 col-12">
                <div class="login-box">
                    ...
                    <div class="form-group">
                        <label class="nunito">Username</label>
                    ...
                    <center>
                    <small>Belum Punya Akun? <a  href="{{url('/pendaftaran')}}"class="text-primary">Klik Disini</a></small>
                    </center>
                </div>
            </div>
        </div>   
